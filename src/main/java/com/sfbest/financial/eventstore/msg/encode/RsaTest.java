...
public class RsaTest {
    ...
    public static void main(String[] args) throws Exception {
        ...
        PrivateKey privateKey1 = keyFactory.generatePrivate(new PKCS8EncodedKeySpec(Base64.decode(privateKey.getBytes())));
        System.out.println(privateKey1);
        System.out.println(Base64.encode(keyFactory.translateKey(privateKey1).getEncoded()));
